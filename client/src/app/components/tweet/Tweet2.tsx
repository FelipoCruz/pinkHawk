...
type Props = {
  ...
  moveTweetToQueue?: (tweet: ITweet, index: number) => void;
  index: number;
};

const SingleTweetTest2 = ({
  tweet,
  deleteTweet,
  moveTweetToQueue,
  index,
    ...
    <>
      <div className={isEditing ? 'tweet-wrap-dark' : 'tweet-wrap'}>
        ...
        {tweet.status === 'queued' ? (
          <div className="date-container">
            <p className="date-header">
              ...
              <span>
                {' '}
                {dayjs(String(tweet.postingTimestamp)).format('DD/MM/YY HH:mm')}
              </span>
            </p>
          </div>
        ) : null}
        ...
        <div className="tweet-header">
          <img
            src={!user.profilePicture ? userIcon : user.profilePicture}
          ...
          <div className="tweet-header-info">
            <div className="icon-group">
              ...
              {tweet.status === 'suggested' ? (
                <span
                  className="material-symbols-outlined"
                  onClick={() => moveTweetToQueue!(tweet, index)}
                >
                  add_circle
                </span>
              ) : null}
            ...
            <div className="tweet-info-counts">
              ...
              <div className="likes">
                ...
                <div className="likes-count">{generateLikes() + 'k'}</div>
              </div>
            </div>
          </div>
        </div>
